    ...
    <div class="row">
        <div class="col-md-3 user_profile_details column">
          ...
          <div class="user_profile_details_left_right">
            ...
            <br><br/>
            <?php echo "<b>Должность:</b><br> " . $user_array['title']. "<br>"; 
            echo "<br><b>Обо мне:</b><br> " . $user_array['about']. "<br>";
            echo "<br><b>Друзья:</b> " . $num_friends . "<br>";;
            if($userLoggedIn != $username) {
                echo "<br><b>Общие друзья:</b> " . $profile_user_obj->getMutualFriends($username);
            }
            ?>
          </div>
        ...
        <div class="user_profile_button_details column">
          <form action="<?php echo "profile.php?profile_username=" . $username; ?>" method="POST">
			...
			if($profile_user_obj->isBlocked()) {
               header("Location: user_block.php"); // блок пользователя
            }
            ...
            if($userLoggedIn != $username) {
              ...
              if($logged_in_user_obj->isFriend($username)) {
                ...
                echo '<input type="submit" name="add_friend" class="success" value="Добвить друга"><br>';

            }

            ?>
          </form>
          <input type="submit" class="danger" data-toggle="modal" data-target="#post_form" value="Опубликуйте новость!">
        ...
        <div class="col-md-3 user_friends_details columnFriends" id="conversations">
          ...
          <ul class="nav nav-tabs" role="tablist" id="profileTabs">
            <li role="presentation" class="active"><a href="#newsfeed_div" aria-controls="newsfeed_div" role="tab" data-toggle="tab">Новости</a></li>
            <li role="presentation"><a href="#about_div" aria-controls="about_div" role="tab" data-toggle="tab">Обо мне</a></li>
          ...
          <div class="tab-content">
            ...
            <form action="<?php echo "profile.php?profile_username=" . $username; ?>" method="POST">
              ...
              if ($username != $userLoggedIn){
                ...
                <br><br>
                    <tr><td class="tg-9hbo"><h4>Фамилия: </h4></td> 
              ...
              echo '<br><div style="text-align: center;"><input type="submit" name="update_details" id="save_details" value="Обновить детали" class="danger settings_submit"></div><br>';
            }
              ?>
          </form>
            ...
            <div role="tabpanel" class="tab-pane fade" id="messages_div">
              <?php  
                ...
                echo "<h4>Вы и <a href='profile.php?profile_username=" . $username ."'>" . $profile_user_obj->getFirstAndLastName() . "</a></h4><hr><br>";
              ...
              <div class="message_post">
                <form action="" method="POST">
                    <textarea name='message_body' id='message_textarea' placeholder='Напишите Ваше сообщение ...'></textarea>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="postModalLabel">Опубликовать новость !</h4>
            </div>

            <div class="modal-body">
            	<p>Это будет отображаться на странице профиля пользователя, а также в его ленте новостей для ваших друзей!</p>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="black-background danger" name="post_button" id="submit_profile_post">Опубликовать</button>
            </div>
          </div>
        </div>
      </div>
