    ...
    <div class="row">
        <div class="col-md-3 user_profile_details column">
          ...
          <div class="user_profile_details_left_right">
            ...
            <br>
            <?php echo "<br><b>О группе:</b><br> " . $group_array['about']. "<br>";
            echo "<br><b>Посты:</b><br> " . $group_array['num_posts']. "<br>"; 
            echo "<br><b>Участники:</b><br> " . $group_array['num_users']. "<br>"; 

            if($userLoggedIn != $group_array['group_owner']) {
                echo "<br><b>" . $group_user_obj->getMutualFriends() . " число друзей в группе</b>";;
            }
            ?>
          </div>
        ...
        <form action="<?php echo "group.php?group_name=".$groupName; ?>" method="POST">
            ...
            if($userLoggedIn != $group_owner) {
              ...
              if($group_user_obj->isMember() && $groupName!="IU_Global_Forum") {
                echo '<input type="submit" name="leave_group" class="danger" value="Покинуть группу"><br>';
              }
                ...
                echo '<input type="submit" name="join_group" class="success" value="Присоединиться к группе"><br>';


            }
            // Not Sure about the below func
            else{
              echo '<input type="submit" name="delete_group" id="delete_group_button" class="danger" value="Удалить группу"><br>';
          ...
          if($group_user_obj->isMember()) {
                echo '<input type="submit" id = "post_button" class="danger" data-toggle="modal" data-target="#post_form" value="Опубликуйте новость">';
              }
          ?>
        ...
        <div class="col-md-6 profile_main_column column">
          ...
          <ul class="nav nav-tabs" role="tablist" id="profileTabs">
            <li role="presentation" class="active"><a href="#newsfeed_div" aria-controls="newsfeed_div" role="tab" data-toggle="tab">Новостная лента</a></li>
            <li role="presentation"><a href="#about_div" aria-controls="about_div" role="tab" data-toggle="tab">О группе</a></li>
            <li role="presentation"><a href="#messages_div" aria-controls="messages_div" role="tab" data-toggle="tab">Сообщения</a></li>
          </ul>
          ...
          <div class="tab-content">
            ...
            <form action="<?php echo "group.php?group_name=" . $groupName; ?>" method="POST">
              ...
              if ($group_owner != $userLoggedIn){
                ...
                <br><br>
                    <tr><td class="tg-9hbo"><h4>Создатель группы: </h4></td> 
            ...
            <div role="tabpanel" class="tab-pane fade" id="messages_div">
              <?php  
                ...
                echo "<h4><a href='group.php?group_name=" . $groupName ."'>" . $group_user_obj->getGroupName() . "</a> Обсуждения </h4><hr><br>";
              ...
              if($group_user_obj->isMember()) {
                    echo '<div class="message_post">
                          <form action="" method="POST">
                              <textarea name="message_body" id="message_textarea" placeholder="Напишите сообщение ..."></textarea>
                              <input type="submit" name="post_message" class="info" id="message_submit" value="Отправить">
                          </form>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="postModalLabel">Поделитесь с друзьями новостью!</h4>
            </div>

            <div class="modal-body">
              <p>Это появится на странице профиля группы, а также в ленте новостей ваших друзей!</p>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="black-background danger" name="post_button" id="submit_group_post">опубликовать</button>
            </div>
          </div>
        </div>
      </div>
