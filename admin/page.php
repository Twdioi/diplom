	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="/IUSocial-master/index.php">Посмотреть сайт</a></li>
				<li class="dropdown ">
	...
	<div class="container-fluid main-container">
		<div class="col-md-2 sidebar">
			<ul class="nav nav-pills nav-stacked">
				<li class="active"><a href="./page.php?page=dashboard">Главная</a></li>
				<li><a href="./page.php?page=banned">Banned</a></li>
				...
				<li><a href="./page.php?page=users">Пользователи</a></li>
			</ul>
		</div>
