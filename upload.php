...
***********************************************************/
	if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
		//Delete users temp image
			$temppath = 'assets/images/profile_pics/'.$profile_id.'_AAAAAAAAAAAAA.jpeg';
...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/connect/assets/images/profile_pics';
	//Set File name	
		$file_temp_name = $profile_id.'_original'.'n'.$type; //the temp file name
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$result_path ="assets/images/profile_pics/".$file_name;
